...
Email::Store::Entity->table("mail_entity");
...
use base "Email::Store::DBI";
Email::Store::Addressing->table("mail_addressing");
...
__DATA__
CREATE TABLE IF NOT EXISTS mail_entity (
    id integer auto_increment NOT NULL PRIMARY KEY,
    notes text
);

CREATE TABLE IF NOT EXISTS mail_addressing (
    id integer auto_increment NOT NULL PRIMARY KEY,
    mail varchar(255),
    role varchar(20),
    entity integer,
...
CREATE TABLE IF NOT EXISTS mail_name (
    id integer auto_increment NOT NULL PRIMARY KEY,
    name varchar(255)
);
